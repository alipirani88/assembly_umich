...
def quast_evaluation(out_path, final_l500_contig, final_l500_plasmid_contig, logger, Config):
    ...
    cmd_assembly = ConfigSectionMap("bin_path", Config)['binbase'] + ConfigSectionMap("quast", Config)['quast_bin'] + ConfigSectionMap("quast", Config)['base_cmd'] + " " + final_l500_contig + " -o " + quast_out + " -t 0,1000,5000,10000,25000,50000"
