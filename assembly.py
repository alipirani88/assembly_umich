...
def spades_assembly(forward_paired, reverse_paired, forward_unpaired, reverse_unpaired, out_path):
    ...
    if paired == "0" and unpaired == "0":
        ...
        plasmid_cmdstring = ConfigSectionMap("bin_path")['binbase'] + ConfigSectionMap("spades")['spades_bin'] + ConfigSectionMap("spades")['base_cmd'] + " " + ConfigSectionMap("spades")['plasmid_spades_parameters'] + " --pe1-1 " + forward_paired + " --pe1-2 " + reverse_paired + " --pe1-s " + forward_unpaired + " --pe1-s " + reverse_unpaired + " -o " + out_path + "spades_plasmid_results"
        print "Running Spades and plasmid Spades with all input file parameters:\n"
        print "Running: %s \n" % cmdstring
        print "Running: %s \n" % plasmid_cmdstring
        os.system(cmdstring)
        os.system(plasmid_cmdstring)
